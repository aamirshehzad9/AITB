...
<#
.SYNOPSIS
    Install AITB Bot service to green staging slot using NSSM
...
.DESCRIPTION
    ...
    - Configures logging to D:\logs\aitb\bot\
...
.EXAMPLE
    .\install-bot-green.ps1 -Version "1.0.0"
    
.EXAMPLE
    .\install-bot-green.ps1 -Version "1.0.0" -NSSMPath "C:\Tools\nssm\nssm.exe"
#>
...
# Configuration
$SERVICE_NAME = "AITB-Bot-Green"
$SERVICE_DISPLAY_NAME = "AITB Trading Bot (Green Slot)"
$SERVICE_DESCRIPTION = "AI Trading Bot main trading service running in green staging slot"

$AITB_ROOT = "D:\apps\aitb"
$LOGS_ROOT = "D:\logs\aitb"
$GREEN_SLOT = "green"

$SERVICE_PATH = Join-Path $AITB_ROOT "bot\$GREEN_SLOT\$Version"
$PYTHON_EXE = Join-Path $SERVICE_PATH ".venv\Scripts\python.exe"
$MAIN_SCRIPT = Join-Path $SERVICE_PATH "main.py"
$LOG_PATH = Join-Path $LOGS_ROOT "bot"
$STDOUT_LOG = Join-Path $LOG_PATH "bot-green-stdout.log"
$STDERR_LOG = Join-Path $LOG_PATH "bot-green-stderr.log"
...
function Install-BotService {
    ...
    Write-Log "Installing AITB Bot service using NSSM"
...
# Main execution
Write-Log "Starting AITB Bot Green service installation"
...
# Install service
$success = Install-BotService -NSSMExe $nssmExe
