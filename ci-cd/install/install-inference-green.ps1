...
<#
.SYNOPSIS
    Install AITB Inference service to green staging slot using NSSM
...
.DESCRIPTION
    ...
    - Configures logging to D:\logs\aitb\inference\
...
.EXAMPLE
    .\install-inference-green.ps1 -Version "1.0.0"
    
.EXAMPLE
    .\install-inference-green.ps1 -Version "1.0.0" -NSSMPath "C:\Tools\nssm\nssm.exe"
#>
...
# Configuration
$SERVICE_NAME = "AITB-Inference-Green"
$SERVICE_DISPLAY_NAME = "AITB Inference Service (Green Slot)"
$SERVICE_DESCRIPTION = "AI Trading Bot inference service running in green staging slot"

$AITB_ROOT = "D:\apps\aitb"
$LOGS_ROOT = "D:\logs\aitb"
$GREEN_SLOT = "green"

$SERVICE_PATH = Join-Path $AITB_ROOT "inference\$GREEN_SLOT\$Version"
$PYTHON_EXE = Join-Path $SERVICE_PATH ".venv\Scripts\python.exe"
$MAIN_SCRIPT = Join-Path $SERVICE_PATH "main.py"
$LOG_PATH = Join-Path $LOGS_ROOT "inference"
$STDOUT_LOG = Join-Path $LOG_PATH "inference-green-stdout.log"
$STDERR_LOG = Join-Path $LOG_PATH "inference-green-stderr.log"
...
function Install-InferenceService {
    param([string]$NSSMExe)
    
    Write-Log "Installing AITB Inference service using NSSM"
...
# Main execution
Write-Log "Starting AITB Inference Green service installation"
...
# Install service
$success = Install-InferenceService -NSSMExe $nssmExe
